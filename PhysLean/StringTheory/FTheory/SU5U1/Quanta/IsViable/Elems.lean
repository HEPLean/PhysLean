...
def viableElems  : (I : CodimensionOneConfig) →  Tree (Option ℤ) (Option ℤ) FiveQuanta TenQuanta
  | .same => root {trunk (some (-3)) {branch (some 0) {twig {(-2, 3, -3), (-1, 0, 3)} {leaf {(0, 3, 0)}, leaf {(-3, 1, 0), (0, 2, 0)}, leaf {(-3, 2, 0), (0, 1, 0)}}},
    ...
    twig {(-2, 2, -2), (0, 0, 2), (3, 1, 0)} {leaf {(-2, 1, 0), (3, 2, 0)}, leaf {(-2, 2, 0), (3, 1, 0)}}}},
  trunk (some 2) {branch (some (-2)) {twig {(-3, 0, 3), (-1, 3, -3)} {leaf {(-3, 1, -1), (-1, 2, 1)}, leaf {(-3, 2, -1), (-1, 1, 1)}},
    twig {(-1, 1, 2), (1, 2, -2)} {leaf {(-1, 3, 0)}, leaf {(-3, 1, 0), (-1, 2, 0)}, leaf {(-3, 2, 0), (-1, 1, 0)}},
    twig {(-1, 0, 2), (1, 3, -2)} {leaf {(-1, 3, 0)}, leaf {(-3, 1, 0), (-1, 2, 0)}, leaf {(-3, 2, 0), (-1, 1, 0)}},
    twig {(-3, 1, 0), (-1, 0, 2), (1, 2, -2)} {leaf {(-1, 3, 0)}, leaf {(-3, 1, 0), (-1, 2, 0)}, leaf {(-3, 2, 0), (-1, 1, 0)}}},
    branch (some (-1)) {twig {(0, 0, 3), (1, 3, -3)} {leaf {(-3, 1, 0), (2, 2, 0)}, leaf {(-3, 2, 0), (2, 1, 0)}}},
    branch (some 0) {twig {(1, 1, 2), (3, 2, -2)} {leaf {(0, 1, -1), (2, 2, 1)}, leaf {(0, 2, -1), (2, 1, 1)}},
    twig {(1, 0, 2), (3, 3, -2)} {leaf {(0, 1, -1), (2, 2, 1)}, leaf {(0, 2, -1), (2, 1, 1)}}},
    branch (some 1) {twig {(3, 3, 0)} {leaf {(0, 2, 1), (1, 1, -1)}, leaf {(0, 1, 1), (1, 2, -1)}}}},
  trunk (some (-2)) {branch (some (-1)) {twig {(-3, 3, 0)} {leaf {(-1, 1, -1), (0, 2, 1)}, leaf {(-1, 2, -1), (0, 1, 1)}}},
    branch (some 0) {twig {(-3, 2, -2), (-1, 1, 2)} {leaf {(-2, 2, 1), (0, 1, -1)}, leaf {(-2, 1, 1), (0, 2, -1)}},
    twig {(-3, 3, -2), (-1, 0, 2)} {leaf {(-2, 2, 1), (0, 1, -1)}, leaf {(-2, 1, 1), (0, 2, -1)}}},
    branch (some 1) {twig {(-1, 3, -3), (0, 0, 3)} {leaf {(-2, 1, 0), (3, 2, 0)}, leaf {(-2, 2, 0), (3, 1, 0)}}},
    branch (some 2) {twig {(-1, 2, -2), (1, 1, 2)} {leaf {(1, 3, 0)}, leaf {(1, 1, 0), (3, 2, 0)}, leaf {(1, 2, 0), (3, 1, 0)}},
    twig {(-1, 3, -2), (1, 0, 2)} {leaf {(1, 3, 0)}, leaf {(1, 1, 0), (3, 2, 0)}, leaf {(1, 2, 0), (3, 1, 0)}},
    twig {(1, 3, -3), (3, 0, 3)} {leaf {(1, 2, 1), (3, 1, -1)}, leaf {(1, 1, 1), (3, 2, -1)}},
    twig {(-1, 2, -2), (1, 0, 2), (3, 1, 0)} {leaf {(1, 3, 0)}, leaf {(1, 1, 0), (3, 2, 0)}, leaf {(1, 2, 0), (3, 1, 0)}}}},
  trunk (some (-1)) {branch (some 0) {twig {(-3, 0, 1), (-2, 3, -3), (-1, 0, 2)} {leaf {(0, 3, 0)}}},
    branch (some 2) {twig {(0, 3, -3), (1, 0, 3)} {leaf {(1, 3, 0)},
      leaf {(1, 1, 0), (2, 2, 0)},
      leaf {(1, 2, 0), (2, 1, 0)},
      leaf {(1, 1, 0), (3, 2, 0)},
      leaf {(1, 2, 0), (3, 1, 0)},
  ...
  trunk (some 1) {branch (some (-2)) {twig {(-1, 0, 3), (0, 3, -3)} {leaf {(-1, 3, 0)},
      ...
      leaf {(-2, 1, 0), (-1, 2, 0)},
      leaf {(-2, 2, 0), (-1, 1, 0)},
      leaf {(-3, 1, 0), (-2, 1, 0), (-1, 1, 0)}}},
    branch (some 0) {twig {(1, 0, 2), (2, 3, -3), (3, 0, 1)} {leaf {(0, 3, 0)}}}},
  trunk (some 3) {branch (some 0) {twig {(1, 0, 3), (2, 3, -3)} {leaf {(0, 3, 0)}, leaf {(0, 1, 0), (3, 2, 0)}, leaf {(0, 2, 0), (3, 1, 0)}}},
    branch (some (-1)) {twig {(0, 1, 2), (2, 2, -2)} {leaf {(-3, 1, 0), (2, 2, 0)}, leaf {(-3, 2, 0), (2, 1, 0)}},
    twig {(0, 0, 2), (2, 3, -2)} {leaf {(-3, 1, 0), (2, 2, 0)}, leaf {(-3, 2, 0), (2, 1, 0)}},
    twig {(-3, 1, 0), (0, 0, 2), (2, 2, -2)} {leaf {(-3, 1, 0), (2, 2, 0)}, leaf {(-3, 2, 0), (2, 1, 0)}}}}}
  | .nearestNeighbor => root {trunk (some (-9)) {branch (some (-14)) {twig {(-9, 0, 2), (-4, 3, -3), (1, 0, 1)} {leaf {(-7, 3, 0)}, leaf {(-12, 1, 0), (-7, 2, 0)}, leaf {(-12, 2, 0), (-7, 1, 0)}}}},
 trunk (some 1) {branch (some (-14)) {twig {(-9, 0, 3), (-4, 3, -3)} {leaf {(-7, 3, 0)}, leaf {(-12, 1, 0), (-7, 2, 0)}, leaf {(-12, 2, 0), (-7, 1, 0)}}}},
 trunk (some 6) {branch (some (-14)) {twig {(-9, 1, 2), (1, 2, -2)} {leaf {(-7, 3, 0)}, leaf {(-12, 1, 0), (-7, 2, 0)}, leaf {(-12, 2, 0), (-7, 1, 0)}},
   twig {(-9, 0, 2), (1, 3, -2)} {leaf {(-7, 3, 0)}, leaf {(-12, 1, 0), (-7, 2, 0)}, leaf {(-12, 2, 0), (-7, 1, 0)}},
   twig {(-9, 0, 2), (1, 2, -2), (11, 1, 0)} {leaf {(-7, 3, 0)}},
   twig {(-9, 0, 2), (-4, 1, 0), (1, 2, -2)} {leaf {(-7, 3, 0)}, leaf {(-12, 1, 0), (-7, 2, 0)}, leaf {(-12, 2, 0), (-7, 1, 0)}}}}}
  | .nextToNearestNeighbor =>root {trunk (some (-3)) {branch (some 12) {twig {(2, 3, -3), (7, 0, 3)} {leaf {(6, 3, 0)}, leaf {(6, 1, 0), (11, 2, 0)}, leaf {(6, 2, 0), (11, 1, 0)}}}}}
