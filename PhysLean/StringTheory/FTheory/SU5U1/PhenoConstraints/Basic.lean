...
W¹-term (W¹ᵢⱼₖₗ 10ⁱ 10ʲ 10ᵏ 5̄Mˡ) : {(chargeW1Term 𝓜.Q5
...
𝜆-term (𝜆ᵢⱼₖ 5̄Mⁱ 5̄Mʲ 10ᵏ) : {(chargeLambdaTerm 𝓜.Q5
  (𝓜.quantaTen.map QuantaTen.q)).sort LE.le}
K¹-term (K¹ᵢⱼₖ 10ⁱ 10ʲ 5Mᵏ) : {(chargeK1Term 𝓜.Q5
  (𝓜.quantaTen.map QuantaTen.q)).sort LE.le}
...
def RParityU1Constrained : Prop :=
  ...
  -- `K¹ᵢⱼₖ 10ⁱ 10ʲ 5Mᵏ`
  ∧ 0 ∉ chargeK1Term 𝓜.Q5 (𝓜.quantaTen.map QuantaTen.q)
  -- `K²ᵢ 5̄Hu 5̄Hd 10ⁱ`
...
def ProtonDecayU1Constrained : Prop :=
  -- `W¹ᵢⱼₖₗ 10ⁱ 10ʲ 10ᵏ 5̄Mˡ`
  0 ∉ chargeW1Term 𝓜.Q5 (𝓜.quantaTen.map QuantaTen.q)
  -- `𝜆ᵢⱼₖ 5̄Mⁱ 5̄Mʲ 10ᵏ`
  ∧ 0 ∉ chargeLambdaTerm 𝓜.Q5
    (𝓜.quantaTen.map QuantaTen.q)
  -- `W²ᵢⱼₖ 10ⁱ 10ʲ 10ᵏ 5̄Hd`
...
def HasABottomYukawa (𝓜 : MatterContent I) : Prop :=
  0 ∈ chargeYukawaBottom 𝓜.Q5 (𝓜.quantaTen.map QuantaTen.q) 𝓜.qHu
