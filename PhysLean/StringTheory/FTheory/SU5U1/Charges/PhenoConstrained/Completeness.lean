...
def completionTopYukawa (I : CodimensionOneConfig) : Tree :=
  match I with
  | same => root {trunk (some (-3)) {branch (some 3) {twig {-1} {leaf {-2, -1}}, twig {0}
        {leaf {-2, -1}}, twig {2} {leaf {-2, -1}}},
      branch (some (-2)) {twig {0} {leaf {-2, -1}}, twig {1} {leaf {-3, 0}},
        twig {2} {leaf {-2, -1}, leaf {-3, 0}}},
      branch (some (-1)) {twig {0} {leaf {-2, -1}}, twig {-2} {leaf {-3, 0}},
        twig {2} {leaf {-2, -1}, leaf {-3, 0}}},
      ...
      twig {-1} {leaf {-2, -1}, leaf {-3, 0}},
      twig {2} {leaf {-2, -1}, leaf {-3, 0}}},
      branch (some 2) {twig {0} {leaf {-2, -1}}, twig {-2} {leaf {-3, 0}},
        twig {-1} {leaf {-2, -1}, leaf {-3, 0}}, twig {1} {leaf {-3, 0}}}},
    trunk (some (-2)) {branch (some 1) {twig {0} {leaf {-1}},
      ...
      branch (some (-1)) {twig {1} {leaf {-1}}, twig {2} {leaf {-1}},
        twig {-3} {leaf {-1}, leaf {-2, 0}}, twig {3} {leaf {-2, 0}, leaf {-3, 1}}},
      ...
      twig {0} {leaf {-1}, leaf {-3, 1}},
      twig {3} {leaf {-3, 1}}},
      branch (some 3) {twig {-3} {leaf {-2, 0}}, twig {-1} {leaf {-2, 0}, leaf {-3, 1}},
        twig {0} {leaf {-3, 1}}}},
    ...
    trunk (some 0) {branch (some (-3)) {twig {3} {leaf {-2, 2}}},
      ...
      branch (some (-2)) {twig {-1} {leaf {-3, 3}}, twig {1} {leaf {-3, 3}},
        twig {2} {leaf {-3, 3}}},
      branch (some (-1)) {twig {-3} {leaf {-2, 2}}, twig {3} {leaf {-2, 2}},
        twig {1} {leaf {-3, 3}}, twig {2} {leaf {-3, 3}}},
      branch (some 1) {twig {-3} {leaf {-2, 2}}, twig {3} {leaf {-2, 2}},
        twig {-2} {leaf {-3, 3}}, twig {-1} {leaf {-3, 3}}},
      branch (some 2) {twig {-2} {leaf {-3, 3}}, twig {-1} {leaf {-3, 3}},
        twig {1} {leaf {-3, 3}}}},
    ...
    trunk (some 2) {branch (some (-1)) {twig {-2} {leaf {1}},
      ...
      branch (some (-3)) {twig {3} {leaf {0, 2}}, twig {0} {leaf {-1, 3}},
      ...
      branch (some 1) {twig {-2} {leaf {1}}, twig {-1} {leaf {1}},
        twig {3} {leaf {1}, leaf {0, 2}}, twig {-3} {leaf {0, 2}, leaf {-1, 3}}},
      branch (some 3) {twig {-2} {leaf {1}},
      twig {-1} {leaf {1}},
      twig {-3} {leaf {0, 2}, leaf {-1, 3}},
      twig {0} {leaf {1}, leaf {-1, 3}},
      twig {1} {leaf {1}, leaf {0, 2}, leaf {-1, 3}}}},
    trunk (some 3) {branch (some (-3)) {twig {-2} {leaf {1, 2}}, twig {0} {leaf {1, 2}},
        twig {1} {leaf {1, 2}}},
      branch (some (-2)) {twig {0} {leaf {1, 2}}, twig {-1} {leaf {0, 3}},
        twig {1} {leaf {1, 2}, leaf {0, 3}}, twig {2} {leaf {0, 3}}},
      ...
      twig {1} {leaf {1, 2}, leaf {0, 3}},
      twig {2} {leaf {0, 3}}},
      branch (some 1) {twig {0} {leaf {1, 2}}, twig {-2} {leaf {1, 2}, leaf {0, 3}},
        twig {2} {leaf {0, 3}}},
      branch (some 2) {twig {0} {leaf {1, 2}}, twig {-2} {leaf {1, 2}, leaf {0, 3}},
        twig {-1} {leaf {0, 3}}}}}
  | nearestNeighbor => root {trunk (some (-14)) {branch (some (-9)) {twig {1} {leaf {-7}},
        twig {6} {leaf {-7}}, twig {11} {leaf {-7}, leaf {-12, -2}}},
      branch (some (-4)) {twig {1} {leaf {-7}}, twig {-9} {leaf {-7}, leaf {-12, -2}},
      ...
      twig {-9} {leaf {-7}, leaf {-12, -2}},
      twig {11} {leaf {-7}, leaf {-12, -2}}},
      branch (some 11) {twig {-4} {leaf {-7}}, twig {1} {leaf {-7}}, twig {6} {leaf {-7}},
        twig {-9} {leaf {-7}, leaf {-12, -2}}}},
    ...
    trunk (some 6) {branch (some 1) {twig {-14} {leaf {3}}, twig {11} {leaf {3}}},
      ...
      branch (some (-4)) {twig {1} {leaf {3}}, twig {-9} {leaf {-7, 13}},
        twig {11} {leaf {3}, leaf {-7, 13}}},
      branch (some 11) {twig {-14} {leaf {3}}, twig {1} {leaf {3}}, twig {-9} {leaf {-7, 13}},
        twig {-4} {leaf {3}, leaf {-7, 13}}}},
  ...
  | nextToNearestNeighbor => root {trunk (some (-13)) {
      branch (some (-8)) {twig {7} {leaf {-9, -4}}},
    ...
    trunk (some (-8)) {branch (some 7) {twig {-13} {leaf {-4}}, twig {-3} {leaf {-4}}},
      ...
      branch (some (-3)) {twig {7} {leaf {-4}}, twig {-13} {leaf {-4}, leaf {-9, 1}},
        twig {12} {leaf {-9, 1}}},
      branch (some 2) {twig {-3} {leaf {-4}}, twig {7} {leaf {-4}},
        twig {-13} {leaf {-4}, leaf {-9, 1}}},
      branch (some 12) {twig {-13} {leaf {-9, 1}}}},
    trunk (some 2) {branch (some (-13)) {twig {-8} {leaf {1}}, twig {7} {leaf {1}},
        twig {12} {leaf {1}}},
      branch (some 7) {twig {-13} {leaf {1}}, twig {-8} {leaf {1}}},
      branch (some (-8)) {twig {-13} {leaf {1}}, twig {7} {leaf {1}}, twig {-3} {leaf {-9, 11}},
        twig {12} {leaf {1}, leaf {-9, 11}}},
      branch (some (-3)) {twig {12} {leaf {-9, 11}}},
      branch (some 12) {twig {-13} {leaf {1}}, twig {7} {leaf {1}},
        twig {-8} {leaf {1}, leaf {-9, 11}}, twig {-3} {leaf {-9, 11}}}},
    trunk (some 7) {branch (some (-8)) {twig {-13} {leaf {-4, 11}}},
      branch (some 2) {twig {-13} {leaf {-4, 11}}},
      branch (some 12) {twig {-13} {leaf {-4, 11}}}},
    trunk (some 12) {branch (some (-13)) {twig {-8} {leaf {6}},
        twig {2} {leaf {6}}, twig {7} {leaf {6}}},
      branch (some (-8)) {twig {-13} {leaf {6}}, twig {2} {leaf {6}},
        twig {7} {leaf {6}, leaf {1, 11}}},
      branch (some (-3)) {twig {-13} {leaf {6}}, twig {2} {leaf {6}},
        twig {-8} {leaf {6}, leaf {1, 11}}, twig {7} {leaf {6}, leaf {1, 11}}},
