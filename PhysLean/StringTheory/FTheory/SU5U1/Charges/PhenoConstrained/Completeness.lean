...
private def completionTopYukawa (I : CodimensionOneConfig) : Tree :=
  ...
  | same => root {trunk (some 3) {branch (some (-2)) {twig {-3} {leaf {-2, 0}},
    ...
    trunk (some 0) {branch (some (-3)) {twig {-1} {leaf {-2, -1}}, twig {0} {leaf {-2, -1}}, twig {2} {leaf {-2, -1}}},
  ...
  | nearestNeighbor => root {trunk (some (-9)) {branch (some (-14)) {twig {-4} {leaf {-7}},
      ...
      branch (some (-4)) {twig {-14} {leaf {-2}, leaf {-12, 8}}, twig {-9} {leaf {-2}, leaf {-12, 8}}, twig {11} {leaf {-2}, leaf {-12, 8}}},
      branch (some 1) {twig {-9} {leaf {-12, 13}}, twig {-4} {leaf {-12, 13}}},
      branch (some 6) {twig {-9} {leaf {-2, 8}, leaf {-7, 13}}, twig {-4} {leaf {-7, 13}}, twig {11} {leaf {-2, 8}, leaf {-7, 13}}}},
    trunk (some 11) {branch (some (-14)) {twig {-4} {leaf {-7}},
      twig {1} {leaf {-7}},
      twig {6} {leaf {-7}},
      twig {-9} {leaf {-7}, leaf {-12, -2}},
      twig {11} {leaf {-7}, leaf {-12, -2}}},
      branch (some (-9)) {twig {-14} {leaf {-12, 3}}, twig {-4} {leaf {-12, 3}}, twig {1} {leaf {-12, 3}}, twig {11} {leaf {-12, 3}}},
    ...
    trunk (some 6) {branch (some (-14)) {twig {-9} {leaf {-7}}, twig {-4} {leaf {-7}}, twig {1} {leaf {-7}}, twig {6} {leaf {-7}}, twig {11} {leaf {-7}}},
      branch (some (-4)) {twig {-9} {leaf {-12, 8}}, twig {1} {leaf {-12, 8}}, twig {11} {leaf {-12, 8}}},
      branch (some 1) {twig {-9} {leaf {-12, 13}}},
      branch (some 11) {twig {1} {leaf {3, 8}}}},
    trunk (some (-14)) {branch (some (-9)) {twig {-14} {leaf {-12, 3}}, twig {1} {leaf {-12, 3}}, twig {11} {leaf {-12, 3}}},
      branch (some (-4)) {twig {-14} {leaf {-2}, leaf {-12, 8}},
      twig {-9} {leaf {-2}, leaf {-12, 8}},
      twig {1} {leaf {-12, 8}},
      twig {11} {leaf {-2}, leaf {-12, 8}}},
    ...
    trunk (some (-4)) {branch (some (-14)) {twig {-4} {leaf {-7}},
      ...
      twig {-9} {leaf {-7}, leaf {-12, -2}},
      twig {11} {leaf {-7}, leaf {-12, -2}}},
      branch (some (-9)) {twig {-4} {leaf {-12, 3}}, twig {1} {leaf {-12, 3}}, twig {11} {leaf {-12, 3}}},
      branch (some 1) {twig {11} {leaf {-7, 8}}, twig {-9} {leaf {-12, 13}}, twig {-4} {leaf {-12, 13}}},
      branch (some 6) {twig {-14} {leaf {3}},
      twig {1} {leaf {3}},
      twig {-9} {leaf {-7, 13}},
      twig {-4} {leaf {3}, leaf {-7, 13}},
      twig {11} {leaf {3}, leaf {-7, 13}}}, branch (some 11) {twig {1} {leaf {3, 8}}, twig {-14} {leaf {-2, 13}}}},
    trunk (some 1) {branch (some (-14)) {twig {-4} {leaf {-7}},
      ...
      twig {11} {leaf {-7}, leaf {-12, -2}}},
      branch (some (-9)) {twig {-14} {leaf {-12, 3}}, twig {-4} {leaf {-12, 3}}, twig {1} {leaf {-12, 3}}, twig {11} {leaf {-12, 3}}},
      branch (some (-4)) {twig {-14} {leaf {-2}, leaf {-12, 8}}, twig {1} {leaf {-12, 8}}, twig {11} {leaf {-2}, leaf {-12, 8}}},
      branch (some 6) {twig {-14} {leaf {3}}, twig {-4} {leaf {3}}, twig {1} {leaf {3}}, twig {-9} {leaf {-2, 8}}},
      branch (some 11) {twig {1} {leaf {3, 8}}, twig {-14} {leaf {-2, 13}}}}}
  | nextToNearestNeighbor => root {trunk (some 12) {branch (some (-8)) {twig {-13} {leaf {-9, 1}}, twig {12} {leaf {-9, 1}}},
  branch (some 2) {twig {-13} {leaf {1}}, twig {7} {leaf {1}}, twig {-3} {leaf {-9, 11}}, twig {12} {leaf {1}, leaf {-9, 11}}}},
 trunk (some (-13)) {branch (some (-8)) {twig {7} {leaf {-4}}, twig {-13} {leaf {-4}, leaf {-9, 1}}, twig {12} {leaf {-9, 1}}},
  branch (some (-3)) {twig {-13} {leaf {-4, 1}, leaf {-9, 6}}, twig {-8} {leaf {-9, 6}}, twig {2} {leaf {-9, 6}}},
  branch (some 2) {twig {-8} {leaf {1}}, twig {12} {leaf {1}}, twig {-13} {leaf {1}, leaf {-4, 6}}, twig {7} {leaf {1}, leaf {-4, 6}}},
  branch (some 7) {twig {-13} {leaf {-4, 11}}},
  branch (some 12) {twig {-13} {leaf {6}}, twig {-8} {leaf {6}}, twig {2} {leaf {6}}, twig {7} {leaf {6}}}},
 trunk (some (-3)) {branch (some (-13)) {twig {-3} {leaf {-9, -4}}, twig {7} {leaf {-9, -4}}},
  branch (some (-8)) {twig {-3} {leaf {-4}}, twig {7} {leaf {-4}}},
  branch (some 2) {twig {-13} {leaf {-4, 6}}, twig {-8} {leaf {-9, 11}}, twig {-3} {leaf {-9, 11}}, twig {12} {leaf {-9, 11}}},
  branch (some 12) {twig {-13} {leaf {6}}, twig {-8} {leaf {6}}, twig {2} {leaf {6}}, twig {7} {leaf {6}}}},
 trunk (some (-8)) {branch (some (-13)) {twig {-3} {leaf {-9, -4}}, twig {7} {leaf {-9, -4}}},
  branch (some (-3)) {twig {-13} {leaf {-4, 1}, leaf {-9, 6}}, twig {-8} {leaf {-9, 6}}, twig {7} {leaf {-9, 6}}},
  branch (some 2) {twig {-13} {leaf {1}}, twig {7} {leaf {1}}, twig {-8} {leaf {1}, leaf {-9, 11}}, twig {-3} {leaf {-9, 11}}},
  branch (some 7) {twig {-13} {leaf {-4, 11}}},
  branch (some 12) {twig {-13} {leaf {6}}, twig {2} {leaf {6}}, twig {-8} {leaf {6}, leaf {1, 11}}, twig {7} {leaf {6}, leaf {1, 11}}}},
 trunk (some 2) {branch (some (-13)) {twig {-3} {leaf {-9, -4}}, twig {7} {leaf {-9, -4}}},
  branch (some (-8)) {twig {-3} {leaf {-4}}, twig {7} {leaf {-4}}, twig {-13} {leaf {-4}, leaf {-9, 1}}, twig {12} {leaf {-9, 1}}},
