...
def nonPhenoConstrainedChargesExt (I : CodimensionOneConfig) : Tree :=
  let completionTopYukawa :=  ((((irreducibleElems I topYukawa).map (fromChargeProfile topYukawa)).bind
...
def nonPhenoConstrainedCharges : (I : CodimensionOneConfig) → Tree
 ...
 trunk (some (-4)) {branch (some (-14)) {twig {-9} {leaf {-2}, leaf {-12, -2}}, twig {11} {leaf {-2}, leaf {-12, -2}}},
  ...
  branch (some 11) {twig {-14} {leaf {-2}, leaf {13, -2}}, twig {-14, -9} {leaf {-2}}, twig {-9} {leaf {-2}, leaf {-12, -2}}}},
 ...
 trunk (some (-8)) {branch (some 12) {twig {-13} {leaf {-9, 1}}},
  branch (some (-13)) {twig {12} {leaf {-9, 1}}, twig {-3} {leaf {-4}, leaf {-9, -4}}, twig {7} {leaf {-4}, leaf {-9, -4}}},
  ...
  branch (some 2) {twig {-13} {leaf {-4}, leaf {-9, 1}, leaf {1, -4}, leaf {11, -4}},
   ...
   twig {-13, 7} {leaf {-4}},
   twig {7} {leaf {-4}, leaf {-9, -4}}},
  branch (some 7) {twig {-13} {leaf {-4}, leaf {11, -4}}, twig {-13, -3} {leaf {-4}}, twig {-3} {leaf {-4}, leaf {-9, -4}}}},
 trunk (some 2) {branch (some (-3)) {twig {12} {leaf {-9, 11}}},
  ...
  branch (some 7) {twig {-13} {leaf {1}}, twig {-13, -8} {leaf {1}}, twig {-8} {leaf {1}, leaf {11, 1}}},
  branch (some 12) {twig {-3} {leaf {-9, 11}},
   ...
   twig {-13, 7} {leaf {1}},
   twig {7} {leaf {1}, leaf {11, 1}}}},
 trunk (some 12) {branch (some 2) {twig {-13} {leaf {6}, leaf {11, 6}}, twig {7} {leaf {6}, leaf {1, 11}, leaf {11, 6}}},
