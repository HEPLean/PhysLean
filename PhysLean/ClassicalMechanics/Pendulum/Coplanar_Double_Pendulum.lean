...
two angles made by the strings with vertical φ1 and φ2 
and two constraints on distance between m1 and pivot and m2 and m1:
x1 = l1 sin(φ1)
y1 = - l1 cos(φ1)
...
T2 = 1/2 m2 (x2_dot^2 + y2_dot^2)                         (Kinetic energy of m2)
= 1/2 m2 [l1^2 φ1_dot^2 + l2^2 φ2_dot^2 + 2 l1 l2 φ1_dot φ2_dot cos(φ1 - φ2)] 
